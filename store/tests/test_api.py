...
class BookApiTestCase(APITestCase):
    def setUp(self):
        ...
        self.book_3 = Book.objects.create(name='TestBook_3 Author 1', price=125,
    ...
    def test_get(self):
        url = reverse('book-list')  # book-detail если надо получить конкретную книгу (/book/)
        with CaptureQueriesContext(connection) as queries:  # проверка на sql query
            response = self.client.get(url)  # self.client - клиент, который делает запрос на сервер
    ...
    def test_get_filter(self):
        ...
        response = self.client.get(url, data={'price': 125})
...
class BooksRelationTestCase(APITestCase):
    ...
    def test_like(self):
        ...
        json_data = json.dumps(data)
        self.client.force_login(self.user)
        # patch тоже самое что и put, только передавать можно одно поле
